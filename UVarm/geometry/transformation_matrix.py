...
#     # Compute the origin transformation matrix
#     T_origin = full_symbolic(xyz, rpy)
    
#     # Compute the joint rotation matrix using Rodrigues' formula
#     kx, ky, kz = axis
#     c = cs.cos(qi)
#     s = cs.sin(qi)
#     v = 1 - c
#     R_joint = cs.SX(3,3)
#     R_joint[0,0] = kx*kx*v + c
#     R_joint[0,1] = kx*ky*v - kz*s
#     R_joint[0,2] = kx*kz*v + ky*s
#     R_joint[1,0] = ky*kx*v + kz*s
#     R_joint[1,1] = ky*ky*v + c
#     R_joint[1,2] = ky*kz*v - kx*s
#     R_joint[2,0] = kz*kx*v - ky*s
#     R_joint[2,1] = kz*ky*v + kx*s
#     R_joint[2,2] = kz*kz*v + c
    
#     # Construct the joint transformation matrix
#     T_joint = cs.SX.eye(4)
#     T_joint[:3,:3] = R_joint
    
#     # Combine the transformations
#     T = cs.mtimes(T_origin, T_joint)
#     return T
...
#     # Compute the joint translation vector
#     translation = cs.SX(3,1)
#     translation[0] = axis[0] * qi
#     translation[1] = axis[1] * qi
#     translation[2] = axis[2] * qi
    
#     # Construct the joint transformation matrix
#     T_joint = cs.SX.eye(4)
#     T_joint[:3,3] = translation
